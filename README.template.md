...
<sub>last updated at {timestamp_for_last_update}<br>updates approximately every hour with randomly selected data from the <i><a href="https://nuforc-sightings-database-api.herokuapp.com/">nuforc-sightings-database-api</a></i></sub><br>
