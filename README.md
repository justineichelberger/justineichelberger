...
<sub>last updated at 00:01:04 on 10 September 2022 (UTC) and again in an hour hence with data from the <i><a href="https://nuforc-sightings-database-api.herokuapp.com/">nuforc-sightings-database-api</a></i></sub><br>

![neural-network-icon-16](./images/hud_cursor_01.gif "feature") <sub>On this day in 2013, an anonymous witness in Talbot (TN) reported seeing craft that fit the description of some 'Cigar' over a period of approximately 0.16666666666666666 - 0.16666666666666666 minutes.</sub><blockquote><sub>Cigar shaped object stationary at low altitude.This sighting is close to a year old but wanted to report it after reading a recent report from the same county.  While returning from a clients house I witnessed a cigar shaped object aprox. 200 ft. off the ground, and stationary.  The country road was winding with many tress that obstructed my view.  When I finally came to a clearing and scanned the skies it was gone.  It was red on each end with a silver band in the middle.  The brief but vivid view I had of it initially was surreal and awesome.</sub></blockquote><sub><sub><i>source: [http://www.nuforc.org/webreports/reports/112/S112854.html](http://www.nuforc.org/webreports/reports/112/S112854.html)</i></sub></sub></sub><br>
<h5><details open>
