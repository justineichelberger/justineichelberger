...
<sub>last updated at 07:00:52 on 23 January 2023 (UTC) and again in an hour hence with data from the <i><a href="https://nuforc-sightings-database-api.herokuapp.com/">nuforc-sightings-database-api</a></i></sub><br>

![neural-network-icon-16](./images/hud_cursor_01.gif "feature") <sub>On this day in 2018, an anonymous witness in Norcross (GA) reported seeing craft that fit the description of some 'Unknown' over a period of approximately 15.0 - 15.0 minutes.</sub><blockquote><sub>Loud noise with windy air like if a helicopter was going to land/no helicopters or planes around.Heard a loud windy noise above my workplace went outside and it felt like if a large fan was blowing it lasted for 15min.  There was no planes or helicopters around.((NUFORC Note:  Witness elects to remain totally anonymous; provides no contact information.  PD))</sub></blockquote><sub><sub><i>source: [http://www.nuforc.org/webreports/reports/138/S138555.html](http://www.nuforc.org/webreports/reports/138/S138555.html)</i></sub></sub></sub><br>
<h5><details open>
