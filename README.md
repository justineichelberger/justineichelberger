...
<sub>last updated at 13:05:17 on 27 November 2022 (UTC) and again in an hour hence with data from the <i><a href="https://nuforc-sightings-database-api.herokuapp.com/">nuforc-sightings-database-api</a></i></sub><br>

![neural-network-icon-16](./images/hud_cursor_01.gif "feature") <sub>On this day in 2020, an anonymous witness in Newton (WI) reported seeing craft that fit the description of some 'Oval' over a period of approximately Seconds - Seconds minutes.</sub><blockquote><sub>Coming home from work I saw a reddish color orb move from east to west horizon to horizon then seconds later it moved from west to east horizon to horizon at an incredible speed. I was at the top of a high hill and could see for miles. Going 50 mph I saw this object and only was able to travel approximately 100 feet in the time this object crossed the sky and came back then it was gone. First thought was meteors don't retrace there exact paths too and fro.</sub></blockquote><sub><sub><i>source: [http://www.nuforc.org/webreports/reports/160/S160872.html](http://www.nuforc.org/webreports/reports/160/S160872.html)</i></sub></sub></sub><br>
<h5><details open>
