...
<sub>last updated at 07:00:39 on 11 May 2023 (UTC) and again in an hour hence with data from the <i><a href="https://nuforc-sightings-database-api.herokuapp.com/">nuforc-sightings-database-api</a></i></sub><br>

![neural-network-icon-16](./images/hud_cursor_01.gif "feature") <sub>On this day in 2005, an anonymous witness in Selinsgrove (PA) reported seeing craft that fit the description of some 'Fireball' over a period of approximately 0.3333333333333333 - 0.3333333333333333 minutes.</sub><blockquote><sub>2-3 craft streak across the skyFacing southeast, craft moved toward northeast.  Then disappeared.  Then, 2 more craft of same appearance and speed appeared to the north west.  One craft moved toward the southeast and the other craft moved toward the northeast at about the same speed.  Speed of all crafts were greater than generated by man.  About 7 minutes after the craft disappered, 2 jets flew by seeming to chase the craft(s).One of the craft made a sound like a jet, but not quite, the other 2 did not.  All the dogs in the neighborhood began barking when the craft flew threw -- also, inside the home, our computer screen froze up about the same time.</sub></blockquote><sub><sub><i>source: [http://www.nuforc.org/webreports/reports/043/S43913.html](http://www.nuforc.org/webreports/reports/043/S43913.html)</i></sub></sub></sub><br>
<h5><details open>
