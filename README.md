...
<sub>last updated at 05:00:30 on 20 October 2024 (UTC) and again in an hour hence with data from the <i><a href="https://nuforc-sightings-database-api.herokuapp.com/">nuforc-sightings-database-api</a></i></sub><br>

![neural-network-icon-16](./images/hud_cursor_01.gif "feature") <sub>On this day in 2019, an anonymous witness in Portland (OR) reported seeing craft that fit the description of some 'Other' over a period of approximately 30.0 - 30.0 minutes.</sub><blockquote><sub>Thin spherical type blue light or beam with sharp edges slowly panning from left to right consistently.  At first thought was it was a spotlight in the area maybe?  But we are in an area that that doesn’t have nor have I seen any of those. Very odd and seemed to be more visible when the clouds would be in front of it.</sub></blockquote><sub><sub><i>source: [http://www.nuforc.org/webreports/reports/150/S150221.html](http://www.nuforc.org/webreports/reports/150/S150221.html)</i></sub></sub></sub><br>
<h5><details open>
