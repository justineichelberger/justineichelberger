...
<sub>last updated at 02:20:30 on 2 September 2024 (UTC) and again in an hour hence with data from the <i><a href="https://nuforc-sightings-database-api.herokuapp.com/">nuforc-sightings-database-api</a></i></sub><br>

![neural-network-icon-16](./images/hud_cursor_01.gif "feature") <sub>On this day in 2013, an anonymous witness in San Tan Valley (AZ) reported seeing craft that fit the description of some 'Triangle' over a period of approximately 25.0 - 25.0 minutes.</sub><blockquote><sub>White Triangle object seen in San Tan Valley, AZ faded as sun setI was driving home from work, and I noticed that there was a bright white light, almost like a star to the North.  The sun was still up and bright, so I knew it was not a start.  I live near an airport, and I figured it was just a plane. As I kept driving, I noticed that it wasn't moving, flashing, or doing anything.  It also looked to be in a triangle shape, with the point down.  It appeared to be a long distance up in the sky, so it is hard to tell.  I snapped a picture on my phone just to see if I could enhance it, and it's just a little dot.  After arriving home, it was still in the sky, so I grabbed my camera and took a picture.  I was able to zoom in enough to see that it was, in fact, a triangle.  It had not moved since I first saw it, and did not move while I was writing up most of this report.  The sun set, and the light started to fade, almost as if it were reflecting an object, not emitting light.  It eventually completely disappeared into the dark sky.  It was at roughly 20º into the sky directly North, almost where the star Polaris would be.  (I figured that a star would get brighter, not darker as the sun set.)</sub></blockquote><sub><sub><i>source: [http://www.nuforc.org/webreports/reports/101/S101864.html](http://www.nuforc.org/webreports/reports/101/S101864.html)</i></sub></sub></sub><br>
<h5><details open>
