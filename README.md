...
<sub>last updated at 22:00:33 on 26 March 2025 (UTC) and again in an hour hence with data from the <i><a href="https://nuforc-sightings-database-api.herokuapp.com/">nuforc-sightings-database-api</a></i></sub><br>

![neural-network-icon-16](./images/hud_cursor_01.gif "feature") <sub>On this day in 2004, an anonymous witness in Lethbridge (Canada) (AB) reported seeing craft that fit the description of some 'Sphere' over a period of approximately 8:30 - 8:30 minutes.</sub><blockquote><sub>I se what seems to be a star but looks like a plane lights so i keep looking and it is still in the same place for awhile i go outside with my digital camera take a couple pictures go inside and zoom in and the more i zoom in there is no light but a round grey ball with no light and i just went upstairs and it is still there in the exact same place i am in lethbridge alberta canada and it is looking to the west towards bc((NUFORC Note:  Witness elects to remain semi-anonymous; provides no contact information.  PD))</sub></blockquote><sub><sub><i>source: [http://www.nuforc.org/webreports/reports/035/S35840.html](http://www.nuforc.org/webreports/reports/035/S35840.html)</i></sub></sub></sub><br>
<h5><details open>
