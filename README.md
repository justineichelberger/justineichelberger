...
<sub>last updated at 02:14:15 on 17 July 2024 (UTC) and again in an hour hence with data from the <i><a href="https://nuforc-sightings-database-api.herokuapp.com/">nuforc-sightings-database-api</a></i></sub><br>

![neural-network-icon-16](./images/hud_cursor_01.gif "feature") <sub>On this day in 2011, an anonymous witness in Muscle Shoals (AL) reported seeing craft that fit the description of some 'Sphere' over a period of approximately Unknown - Unknown minutes.</sub><blockquote><sub>3 glowing red lights in a line.3 spherical objects, each glowing red and amber, were observed flying in a line from east to west.  The front two were closer together with the third trailing behind about twice the distance between the first two. I was unable to judge altitude or size of the objects. There is an airport very close to where I made the observation, however none of the objects had flashing lights like the personal aircraft that frequent that airport.  There was however an airplane circling the area at the time.</sub></blockquote><sub><sub><i>source: [http://www.nuforc.org/webreports/reports/082/S82555.html](http://www.nuforc.org/webreports/reports/082/S82555.html)</i></sub></sub></sub><br>
<h5><details open>
