...
<sub>last updated at 19:00:35 on 28 September 2024 (UTC) and again in an hour hence with data from the <i><a href="https://nuforc-sightings-database-api.herokuapp.com/">nuforc-sightings-database-api</a></i></sub><br>

![neural-network-icon-16](./images/hud_cursor_01.gif "feature") <sub>On this day in 2017, an anonymous witness in Brick (NJ) reported seeing craft that fit the description of some 'Light' over a period of approximately 40.0 - 40.0 minutes.</sub><blockquote><sub>I went outside to put mail in the box and I saw 2 pulsing sort of shimmering lights turning red white, but constanly shimmering.  I watched for about 5 minutes then went inside to call my neighbor.  One disappeared as we were watching smaller lights popped in and out around it.  Then there were 3 shimmering red white.((NUFORC Note:  Witness elects to remain totally anonymous; provides no contact information.  PD))</sub></blockquote><sub><sub><i>source: [http://www.nuforc.org/webreports/reports/136/S136431.html](http://www.nuforc.org/webreports/reports/136/S136431.html)</i></sub></sub></sub><br>
<h5><details open>
