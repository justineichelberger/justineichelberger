...
<sub>last updated at 08:00:45 on 3 July 2022 (UTC) and again in an hour hence with data from the <i><a href="https://nuforc-sightings-database-api.herokuapp.com/">nuforc-sightings-database-api</a></i></sub><br>

![neural-network-icon-16](./images/hud_cursor_01.gif "feature") <sub>On this day in 2011, an anonymous witness in Battle Creek (MI) reported seeing craft that fit the description of some 'Triangle' over a period of approximately 2.0 - 2.0 minutes.</sub><blockquote><sub>Triangular shape, noisless,, object floated through sky over apartment building.Triangular shape craft floating through the sky over the apartment complex.  It was like it was floating through the sky.  There was no noise what so ever, and no cars on West Michigan.  All three of us saw it but didn't believe it until my mother mentioned it.  The craft was black but clearly visible against the sky because when it moved the stars disappeared behind it.  No way possible it was a Stealth. Wasn't the correct shape.</sub></blockquote><sub><sub><i>source: [http://www.nuforc.org/webreports/reports/086/S86588.html](http://www.nuforc.org/webreports/reports/086/S86588.html)</i></sub></sub></sub><br>
<h5><details open>
