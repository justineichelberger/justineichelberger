...
<sub>last updated at 06:00:35 on 3 April 2023 (UTC) and again in an hour hence with data from the <i><a href="https://nuforc-sightings-database-api.herokuapp.com/">nuforc-sightings-database-api</a></i></sub><br>

![neural-network-icon-16](./images/hud_cursor_01.gif "feature") <sub>On this day in 2006, an anonymous witness in Maale Adummim (Israel) () reported seeing craft that fit the description of some 'Other' over a period of approximately flying object - flying object minutes.</sub><blockquote><sub>strange red lights in a semi-circle fly over maale adummim in isreal for 90 secondsme and my fraind was siting in some dark place ..then sudenly i saw some strange lights in the sky it was in a semi-circle  shape and it not was an helicopter or so kinde of a plane it has red light on it and its fly alitelbit more faster the a helicopter...after cupel seconds of shock we saw it fly up to the sky and disapere we dont sure mybe it was 2 objects after it pass over the buldings the lights is shuted down/ the object did not make sounds</sub></blockquote><sub><sub><i>source: [http://www.nuforc.org/webreports/reports/049/S49933.html](http://www.nuforc.org/webreports/reports/049/S49933.html)</i></sub></sub></sub><br>
<h5><details open>
