...
<sub>last updated at 07:00:23 on 24 February 2023 (UTC) and again in an hour hence with data from the <i><a href="https://nuforc-sightings-database-api.herokuapp.com/">nuforc-sightings-database-api</a></i></sub><br>

![neural-network-icon-16](./images/hud_cursor_01.gif "feature") <sub>On this day in 2013, an anonymous witness in Guilford (CT) reported seeing craft that fit the description of some 'Sphere' over a period of approximately 3.0 - 3.0 minutes.</sub><blockquote><sub>it was sphere floating above the rooftops and landid behind a house, this is the 3rd time ive seen it in 3 years now, and i do have a photo of one,((NUFORC Note:  Witness indicates that the date is approximate.  PD))</sub></blockquote><sub><sub><i>source: [http://www.nuforc.org/webreports/reports/096/S96782.html](http://www.nuforc.org/webreports/reports/096/S96782.html)</i></sub></sub></sub><br>
<h5><details open>
