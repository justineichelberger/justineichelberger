...
<sub>last updated at 16:00:41 on 3 September 2022 (UTC) and again in an hour hence with data from the <i><a href="https://nuforc-sightings-database-api.herokuapp.com/">nuforc-sightings-database-api</a></i></sub><br>

![neural-network-icon-16](./images/hud_cursor_01.gif "feature") <sub>On this day in 2010, an anonymous witness in Hayden (ID) reported seeing craft that fit the description of some 'Triangle' over a period of approximately 0.16666666666666666 - 0.16666666666666666 minutes.</sub><blockquote><sub>three dim lights in the sky.i was sitting on my porch playing on my computer as i normally do and i seen two objects then a third moving at very steady yet swift speeds with low light coming from the objects and my computer screen flickered which isn't normal for an LCD monitor , then i went to get my camera but too late i supose  so i went to take another look but no sign of them.</sub></blockquote><sub><sub><i>source: [http://www.nuforc.org/webreports/reports/077/S77605.html](http://www.nuforc.org/webreports/reports/077/S77605.html)</i></sub></sub></sub><br>
<h5><details open>
