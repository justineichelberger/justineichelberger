...
<sub>last updated at 07:00:35 on 10 April 2025 (UTC) and again in an hour hence with data from the <i><a href="https://nuforc-sightings-database-api.herokuapp.com/">nuforc-sightings-database-api</a></i></sub><br>

![neural-network-icon-16](./images/hud_cursor_01.gif "feature") <sub>On this day in 2014, an anonymous witness in Oakland Park (FL) reported seeing craft that fit the description of some 'Triangle' over a period of approximately 240.0 - 240.0 minutes.</sub><blockquote><sub>This has been happening to me for 4 months to my knowledge.Pyramid shapes in the sky; that enveloped the moon.  Then lifted above and around the sky. It seems to be working off the constellations and connecting to each other in a linear perspective.  Also when I closed my eyes I saw what seemed to be another eye-like life form take shape of )( in a lime green, almost feather like.  I walked outside to see the moon went from a green hue to a sahara red.  As I walked further away, another linear shaped object obstructed the image of the moon.</sub></blockquote><sub><sub><i>source: [http://www.nuforc.org/webreports/reports/108/S108504.html](http://www.nuforc.org/webreports/reports/108/S108504.html)</i></sub></sub></sub><br>
<h5><details open>
