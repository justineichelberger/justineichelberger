...
<sub>last updated at 21:00:28 on 20 December 2024 (UTC) and again in an hour hence with data from the <i><a href="https://nuforc-sightings-database-api.herokuapp.com/">nuforc-sightings-database-api</a></i></sub><br>

![neural-network-icon-16](./images/hud_cursor_01.gif "feature") <sub>On this day in 2001, an anonymous witness in Aneta (by/near) (ND) reported seeing craft that fit the description of some 'Circle' over a period of approximately 0.25 - 0.25 minutes.</sub><blockquote><sub>Coming from Grand Forks going west on highway 15. We were looking at Christmas lights when we noticed 5 white lights to the south of us in a circular position.These lights were big not like an airplanes.They flashed one at a time, when the last one came on the others disapeared.Then the lights disappeared.This was a moonless night and we didn't see what shape the object was that the lights came from.So as the lights dissapeared we looked for a sign to let us know our location and it said Aneta 3 miles.That's it.</sub></blockquote><sub><sub><i>source: [http://www.nuforc.org/webreports/reports/020/S20971.html](http://www.nuforc.org/webreports/reports/020/S20971.html)</i></sub></sub></sub><br>
<h5><details open>
