...
<sub>last updated at 03:00:30 on 3 May 2023 (UTC) and again in an hour hence with data from the <i><a href="https://nuforc-sightings-database-api.herokuapp.com/">nuforc-sightings-database-api</a></i></sub><br>

![neural-network-icon-16](./images/hud_cursor_01.gif "feature") <sub>On this day in 2012, an anonymous witness in Oxford (AL) reported seeing craft that fit the description of some 'Fireball' over a period of approximately 2.0 - 2.0 minutes.</sub><blockquote><sub>Fireballs in Oxford, ALI saw two fireballs hovering over the Hampton Inn on Davis Loop.  They hovered for two minutes, then took off at a high rate of speed westward until I could no longer see them.  One appeared to follow the other.  I tried to record this, but due the crappy camera on my phone I could not zoom close enough to differentiate this from stars.  It was a clear night.</sub></blockquote><sub><sub><i>source: [http://www.nuforc.org/webreports/reports/088/S88779.html](http://www.nuforc.org/webreports/reports/088/S88779.html)</i></sub></sub></sub><br>
<h5><details open>
