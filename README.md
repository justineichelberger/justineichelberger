...
<sub>last updated at 10:00:43 on 21 November 2022 (UTC) and again in an hour hence with data from the <i><a href="https://nuforc-sightings-database-api.herokuapp.com/">nuforc-sightings-database-api</a></i></sub><br>

![neural-network-icon-16](./images/hud_cursor_01.gif "feature") <sub>On this day in 2013, an anonymous witness in West Linn (OR) reported seeing craft that fit the description of some 'Other' over a period of approximately 3.0 - 3.0 minutes.</sub><blockquote><sub>3 vertical rectangular lights seen hoveringAround 8pm me and my daughter were driving from Stafford Rd. to Borland Rd. toward the hospital when off to our left we saw 3 incredibly bright lights hovering inbone spot.  All 3 lights were the same shape: long vertical rectangles.  The outer two lights were alternating (pulsing) brighter in sequence.  When we reached Tualatin, we couldn't see them anymore.((NUFORC Note:  Witness elects to remain totally anonymous; provides no contact information.  PD))</sub></blockquote><sub><sub><i>source: [http://www.nuforc.org/webreports/reports/104/S104696.html](http://www.nuforc.org/webreports/reports/104/S104696.html)</i></sub></sub></sub><br>
<h5><details open>
