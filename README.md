...
<sub>last updated at 10:00:34 on 10 May 2023 (UTC) and again in an hour hence with data from the <i><a href="https://nuforc-sightings-database-api.herokuapp.com/">nuforc-sightings-database-api</a></i></sub><br>

![neural-network-icon-16](./images/hud_cursor_01.gif "feature") <sub>On this day in 2016, an anonymous witness in Belmont (MA) reported seeing craft that fit the description of some 'Sphere' over a period of approximately 0.5 - 0.5 minutes.</sub><blockquote><sub>Red fast-moving orbObject seen in sky on clear night, circular and reddish colored.  Looked like airplane red lights, but had no accompanying blink or white/blue light as you typically see with aircraft and it made no noise.  As I watched it moved left to right across the sky, then did a quick swing back to the left, and then out of view to the north.((NUFORC Note:  Witness elects to remain totally anonymous; provides no contact information.  PD))</sub></blockquote><sub><sub><i>source: [http://www.nuforc.org/webreports/reports/127/S127406.html](http://www.nuforc.org/webreports/reports/127/S127406.html)</i></sub></sub></sub><br>
<h5><details open>
