...
<sub>last updated at 23:00:22 on 19 May 2023 (UTC) and again in an hour hence with data from the <i><a href="https://nuforc-sightings-database-api.herokuapp.com/">nuforc-sightings-database-api</a></i></sub><br>

![neural-network-icon-16](./images/hud_cursor_01.gif "feature") <sub>On this day in 2014, an anonymous witness in Oak Ridges (Canada) (ON) reported seeing craft that fit the description of some 'Triangle' over a period of approximately 2.0 - 2.0 minutes.</sub><blockquote><sub>3 warm, large lights, moving from North to South then disappearingFrom the intersection of Bathurst St. and King Rd coming from King City we saw 3 lights  we initially thought it defined a huge triangular shape going from North (Aurora) to South (Richmond Hill).  About one minute later, two of the lights faded than disappeared. about another minute later the remaining light disappeared as well.  The lights we not similar to the spot light of a helicopter searching the ground nor the blinking light that are usually found on the planes wingtips (Buttonville airport is nearby).  No sound was heard whatsoever while those lights passed above us (we stopped the car engine and parked on the side of the road).  The lights source were quite large (larger that as you might see the source of a helicopter searchlight from the ground) and were not cold (towards white) but warm (more yellow).  Sky was clear (no clouds) and stars could faintly be seen  because of the light pollution.  The lights couldn't have been from planes because they flew too slow and couldn't have been helicopters because there was no noise (also flying in formation?!? - maybe millitary?!?)((NUFORC Note:  Witness elects to remain totally anonymous; provides no contact information.  PD))</sub></blockquote><sub><sub><i>source: [http://www.nuforc.org/webreports/reports/109/S109442.html](http://www.nuforc.org/webreports/reports/109/S109442.html)</i></sub></sub></sub><br>
<h5><details open>
