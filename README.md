...
<sub>last updated at 09:00:37 on 25 July 2022 (UTC) and again in an hour hence with data from the <i><a href="https://nuforc-sightings-database-api.herokuapp.com/">nuforc-sightings-database-api</a></i></sub><br>

![neural-network-icon-16](./images/hud_cursor_01.gif "feature") <sub>On this day in 1994, an anonymous witness in San Diego (CA) reported seeing craft that fit the description of some 'Rectangle' over a period of approximately SEA PORT VILLAGE - SEA PORT VILLAGE minutes.</sub><blockquote><sub>I was 17 and my girlfriend  who’s now my wife where at the south end of Sea port Village.  She was sitting down on the grass and I was lying on the grass with my head on her lap faced up looking at the sky.  The sky was partly cloudy, and as I was looking up at the sky, a rectangular space ship with large recessed lighting underneath the space craft was hovering over the clouds moving in a circular motion.  There lights where not on and the space craft appeared  to be carefully moving through the clouds. I've only told a few people about what I saw that day, but I’m hoping to see if there more sighting like this that year.((NUFORC Note:  Witness elects to remain totally anonymous; provides no contact information.  PD))((NUFORC Note:  Source of report indicates that the date of the incident is approximate.  PD))</sub></blockquote><sub><sub><i>source: [http://www.nuforc.org/webreports/reports/068/S68568.html](http://www.nuforc.org/webreports/reports/068/S68568.html)</i></sub></sub></sub><br>
<h5><details open>
