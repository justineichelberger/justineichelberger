...
<sub>last updated at 01:27:37 on 30 September 2024 (UTC) and again in an hour hence with data from the <i><a href="https://nuforc-sightings-database-api.herokuapp.com/">nuforc-sightings-database-api</a></i></sub><br>

![neural-network-icon-16](./images/hud_cursor_01.gif "feature") <sub>On this day in 2013, an anonymous witness in Glen Gardner (NJ) reported seeing craft that fit the description of some 'Unknown' over a period of approximately 20.0 - 20.0 minutes.</sub><blockquote><sub>Stationary object high in the sky that had rapidly flashing lights - colors were distinct - red, green, white and amber.My boyfriend and I were sitting on our front porch looking West, when we noticed an object pretty high up in the sky that was stationary.  It was a dark night, but after looking closely, we could distinctly see flashing lights in the colors of red, green, amber and white.  It once quickly moved straight up into the air, but otherwise remained completely stationary.  The lights flashed intensely and quickly, and the colors could each be made out distinctly.  It was cold, so we decided to go back inside, and did not see it leave the spot in the sky.  I peeked through a window about 15 minutes after we went inside and saw that it was still there, but about an hour later went back outside and there was no sign of it.During that time, we saw approximately 4 airplanes move through the airspace at what seemed like a lower altitude than the object we observed.((NUFORC Note:  We suspect Arcturus.  It would be in the western sky, at the time indicated by the witness.  PD))</sub></blockquote><sub><sub><i>source: [http://www.nuforc.org/webreports/reports/102/S102870.html](http://www.nuforc.org/webreports/reports/102/S102870.html)</i></sub></sub></sub><br>
<h5><details open>
