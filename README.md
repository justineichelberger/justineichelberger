...
<sub>last updated at 03:05:00 on 21 February 2025 (UTC) and again in an hour hence with data from the <i><a href="https://nuforc-sightings-database-api.herokuapp.com/">nuforc-sightings-database-api</a></i></sub><br>

![neural-network-icon-16](./images/hud_cursor_01.gif "feature") <sub>On this day in 2021, an anonymous witness in Albuquerque (NM) reported seeing craft that fit the description of some 'Disk' over a period of approximately  -  minutes.</sub><blockquote><sub>Silver/dull disk with Greenish/Gold dome. Witness provided several photos (3).Object appeared directly over witness, at a very high elevation. Could not get it to show up on video recording, but did show up faintly on picture. When thinking "Come Closer" object responded and came closer, only to the shoot off at high speed w/ no sound.Obj description:</sub></blockquote><sub><sub><i>source: [http://www.nuforc.org/webreports/reports/162/S162302.html](http://www.nuforc.org/webreports/reports/162/S162302.html)</i></sub></sub></sub><br>
<h5><details open>
