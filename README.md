...
<sub>last updated at 23:00:19 on 17 December 2022 (UTC) and again in an hour hence with data from the <i><a href="https://nuforc-sightings-database-api.herokuapp.com/">nuforc-sightings-database-api</a></i></sub><br>

![neural-network-icon-16](./images/hud_cursor_01.gif "feature") <sub>On this day in 2013, an anonymous witness in Winnipeg (Canada) (MB) reported seeing craft that fit the description of some 'Oval' over a period of approximately 10.0 - 10.0 minutes.</sub><blockquote><sub>craft with lights, lemon shaped, moving north west over winnipegA large craft passed over my apartment building had a line of 6(ish) large green lights (orbs?) down the middle and 4 white lights(orbs?) to each corner, appeared to be lemon shaped (lack of better shape to call it)  It appeared to be flying low, and moving slower then a hellicopter, no noise. strong glare.((NUFORC Note:  Witness indicates that the date of the sighting is approximate.  PD))</sub></blockquote><sub><sub><i>source: [http://www.nuforc.org/webreports/reports/105/S105423.html](http://www.nuforc.org/webreports/reports/105/S105423.html)</i></sub></sub></sub><br>
<h5><details open>
