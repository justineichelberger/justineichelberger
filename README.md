...
<sub>last updated at 22:00:36 on 6 December 2023 (UTC) and again in an hour hence with data from the <i><a href="https://nuforc-sightings-database-api.herokuapp.com/">nuforc-sightings-database-api</a></i></sub><br>

![neural-network-icon-16](./images/hud_cursor_01.gif "feature") <sub>On this day in 2004, an anonymous witness in Oxnard to Yuma (enroute) (CA) reported seeing craft that fit the description of some 'Flash' over a period of approximately split seconds - split seconds minutes.</sub><blockquote><sub>intense flashes light up whole skyas i drove back to yuma, az from oxnard, ca i witness two intense flashes that lit up the whole sky. the first flash was blue followed by a red flash. this was located on the 8 headed east after you get to san diego. i could not see any objects in the sky due to what apeared to be a minor snow storm which i drove into just right after the flashes happened. i just want to see if anyone else has witnessed these intense flashes of light. keep in mind that these were not just any flashes but lit up the whhhole sky very, very bright.</sub></blockquote><sub><sub><i>source: [http://www.nuforc.org/webreports/reports/041/S41005.html](http://www.nuforc.org/webreports/reports/041/S41005.html)</i></sub></sub></sub><br>
<h5><details open>
