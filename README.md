...
<sub>last updated at 03:54:16 on 15 September 2022 (UTC) and again in an hour hence with data from the <i><a href="https://nuforc-sightings-database-api.herokuapp.com/">nuforc-sightings-database-api</a></i></sub><br>

![neural-network-icon-16](./images/hud_cursor_01.gif "feature") <sub>On this day in 2004, an anonymous witness in Desert (CA) reported seeing craft that fit the description of some 'Triangle' over a period of approximately 1.0 - 1.0 minutes.</sub><blockquote><sub>Object in the Arizona/California desert was probably a government test.This is a report of an event that occurred in 2004 and includes some knowns.We were flying from Los Angeles to Memphis and were in the vicinity of the California/Arizona border when I saw a four-engined plane in Air Force gray flying a parallel course perhaps a mile below us and at a somewhat slower speed.  As we were passing it I noticed a movement close to the ground. It was a silver colored triangular planform moving eastward at a fairly leisurely pace.  I can make no certain estimate of its size but it appeared to be fairly substantial. It took a left turn proceeding around the edge of a basin in the desert.  It then proceeded to make another left turn, maintaining a similar speed.  This was followed by another left turn that placed it facing a peak that anchored the southeastern corner of the basin.  As it completed this turn the craft appeared to suddenly accelerate as though launched from a slingshot and disappeared.There was no further sign of it.  I don’t believe it hit the peak, which, from my window appeared inevitable.  It may have turned edge-on, but if so the rate of rotation was phenomenal or it may have employed a cloaking method.I mentioned my sighting to the pilot later and he was not surprised and let me know that he had seen a lot of strange things in that area - none of which officially happened.I would connect the loitering plane with the craft. I was unable to determine if the Boeing was a tanker or perhaps a command post of some sort.I really can’t fathom why the powers that be would have scheduled such an outlandish exercise as an airliner was passing overhead full of nosey people like myself.((name deleted))  October 4, 2010((NUFORC Note:  Witness indicates that the date of the sighting is approximate.  PD))</sub></blockquote><sub><sub><i>source: [http://www.nuforc.org/webreports/reports/078/S78207.html](http://www.nuforc.org/webreports/reports/078/S78207.html)</i></sub></sub></sub><br>
<h5><details open>
