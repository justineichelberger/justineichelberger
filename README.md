...
<sub>last updated at 08:00:30 on 19 May 2024 (UTC) and again in an hour hence with data from the <i><a href="https://nuforc-sightings-database-api.herokuapp.com/">nuforc-sightings-database-api</a></i></sub><br>

![neural-network-icon-16](./images/hud_cursor_01.gif "feature") <sub>On this day in 2016, an anonymous witness in  (FL) reported seeing craft that fit the description of some '' over a period of approximately  -  minutes.</sub><blockquote><sub>Enter the postion  N,E,W or S of object seen.This is not a report, but an observation improvement (1) before a report is posted, the position N, E, W or S should be noted along with the time the object was actually seen. This will help in the reliance of the report itself and help prove the possibility of others who witnessed the object as well.((NUFORC Note:  We agree with the comment.  Traditionally, we recommend that witnesses include direction in their reports,  but most people do not know where north is, and are unable to estimate direction.  PD))((NUFORC Note:  Person who submitted the recommendation elects to remain totally anonymous; provides no contact information.  PD))</sub></blockquote><sub><sub><i>source: [http://www.nuforc.org/webreports/reports/127/S127415.html](http://www.nuforc.org/webreports/reports/127/S127415.html)</i></sub></sub></sub><br>
<h5><details open>
