...
<sub>last updated at 03:25:08 on 10 June 2022 (UTC) and again in an hour hence with data from the <i><a href="https://nuforc-sightings-database-api.herokuapp.com/">nuforc-sightings-database-api</a></i></sub><br>

![neural-network-icon-16](./images/hud_cursor_01.gif "feature") <sub>On this day in 2015, an anonymous witness in Edina (MN) reported seeing craft that fit the description of some 'Light' over a period of approximately 30.0 - 30.0 minutes.</sub><blockquote><sub>Large bright light - stationary - growing smaller then larger - brighter then dimmer - disappearing then reappearingI noticed a very bright light in western sky and pointed it out to a friend.  Both of us watched, waiting to see it move-but it did not.  It was very low, airplane height - but the white light was too bright and too large to be a plane.  Besides, it was stationary.  I found a spot on the horizon directly beneath object and the object remained it the same exact place.  After watching it for five minutes, we joked that it might be a new star of Bethlehem - it looked the same as Christmas card depictions.  Then, the light slowly got smaller, yet always keeping an intense center of light, until it became just a tiny pin prick - looking as if it would fade out completely.  But, it would grow brighter and larger again.  There was a pattern of the size and brightness, but it was inconsistent.  Suddenly, my friend noticed a second light, 45 degrees above to the left.  Then a 3rd light, same angle and distance, like Orion's Belt.  Then 1st light began disappearing, reappearing.  Other lights seemed to pulse more in its absence.  It was still going when we left 30 minutes later.</sub></blockquote><sub><sub><i>source: [http://www.nuforc.org/webreports/reports/119/S119475.html](http://www.nuforc.org/webreports/reports/119/S119475.html)</i></sub></sub></sub><br>
<h5><details open>
