...
<sub>last updated at 06:00:38 on 5 July 2024 (UTC) and again in an hour hence with data from the <i><a href="https://nuforc-sightings-database-api.herokuapp.com/">nuforc-sightings-database-api</a></i></sub><br>

![neural-network-icon-16](./images/hud_cursor_01.gif "feature") <sub>On this day in 2014, an anonymous witness in Portage (IN) reported seeing craft that fit the description of some 'Formation' over a period of approximately 20.0 - 20.0 minutes.</sub><blockquote><sub>At least 16 red orbs were moving in an angular pattern eventually dispersing. The pattern would change periodically.Large display of lights in an angular pattern switching position periodically.  Red in color and orb shaped.  The crafts then dispersed into different directions after about 20 minutes.  At least 16 orbs were seen over a residential area.  Could be latterns, but it's highly unlikely.  People in a parking lot were also visually witnessing the orbs also.((NUFORC Note:  Witness elects to remain totally anonymous; provides no contact information.  PD))</sub></blockquote><sub><sub><i>source: [http://www.nuforc.org/webreports/reports/111/S111162.html](http://www.nuforc.org/webreports/reports/111/S111162.html)</i></sub></sub></sub><br>
<h5><details open>
