...
<sub>last updated at 20:00:27 on 26 December 2022 (UTC) and again in an hour hence with data from the <i><a href="https://nuforc-sightings-database-api.herokuapp.com/">nuforc-sightings-database-api</a></i></sub><br>

![neural-network-icon-16](./images/hud_cursor_01.gif "feature") <sub>On this day in 2019, an anonymous witness in Munhall (PA) reported seeing craft that fit the description of some 'Other' over a period of approximately 0.03333333333333333 - 0.03333333333333333 minutes.</sub><blockquote><sub>Very weird,,,,you have to see it to believe it....The object is of a round design ,black in nature,and it appears to be in front of an object that looks like the sun.it has, what looks like little antennas coming out of three side,and a ray of light heading toward my trail camera.  i do have a picture of this object.  There is also a cat in the picture that is close to this object, that it is not disturbed.  Also, this object looks like the object that was photographed from a fighter jet awhile back.  But this object seems to be small in nature.at 10:35 in the morning the sun is above our house, not  5 feet above a 3 foot retaining wall. this is a real weird picture....never seen anything like this..</sub></blockquote><sub><sub><i>source: [http://www.nuforc.org/webreports/reports/152/S152521.html](http://www.nuforc.org/webreports/reports/152/S152521.html)</i></sub></sub></sub><br>
<h5><details open>
