...
<sub>last updated at 08:00:45 on 19 May 2022 (UTC) and again in an hour hence with data from the <i><a href="https://nuforc-sightings-database-api.herokuapp.com/">nuforc-sightings-database-api</a></i></sub><br>

![neural-network-icon-16](./images/hud_cursor_01.gif "feature") <sub>On this day in 2019, an anonymous witness in Bradenton (FL) reported seeing craft that fit the description of some 'Sphere' over a period of approximately 10.0 - 10.0 minutes.</sub><blockquote><sub>7 orange spheres flying in formation.Looking in the eastern sky,I saw a single orange/yellow sphere of light traveling north to south.  Initially I thought it was a rocket launch as I have seen some in the past,same color,same trajectory.  This remained visible longer than usual and it seemed to turn to the east.  About a minute later I saw two more in formation at a considerable distance apart taking the same path.  About 15 seconds later I saw two more in formation and a third seem to come out of nowhere,again at distance apart and about 15 seconds later a final single one came from the same origin, path and speed.  Please note, there was no sound whatsoever, but there was small aircraft (2) in the air at that time flying east and southeast that I know they couldn't help but seeing what I witnessed.</sub></blockquote><sub><sub><i>source: [http://www.nuforc.org/webreports/reports/146/S146180.html](http://www.nuforc.org/webreports/reports/146/S146180.html)</i></sub></sub></sub><br>
<h5><details open>
