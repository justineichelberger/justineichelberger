...
<sub>last updated at 23:00:32 on 4 July 2023 (UTC) and again in an hour hence with data from the <i><a href="https://nuforc-sightings-database-api.herokuapp.com/">nuforc-sightings-database-api</a></i></sub><br>

![neural-network-icon-16](./images/hud_cursor_01.gif "feature") <sub>On this day in 2016, an anonymous witness in Hometown (IL) reported seeing craft that fit the description of some 'Light' over a period of approximately 5.0 - 5.0 minutes.</sub><blockquote><sub>Lighted objects floated over Oak Lawn and Hometown, July 4th, 2016.The object looked like a ball of light in the sky.  I first saw it on Cicero Ave it was floating south.I walked the dog and then I saw three lighted objects followed by four more and then 3 or 4 more behind them they came from the west (Oak Lawn) and flew over hometown, and they went east.</sub></blockquote><sub><sub><i>source: [http://www.nuforc.org/webreports/reports/128/S128310.html](http://www.nuforc.org/webreports/reports/128/S128310.html)</i></sub></sub></sub><br>
<h5><details open>
