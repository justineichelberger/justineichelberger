...
<sub>last updated at 01:28:47 on 10 June 2022 (UTC) and again in an hour hence with data from the <i><a href="https://nuforc-sightings-database-api.herokuapp.com/">nuforc-sightings-database-api</a></i></sub><br>

![neural-network-icon-16](./images/hud_cursor_01.gif "feature") <sub>On this day in 2010, an anonymous witness in Houston (TX) reported seeing craft that fit the description of some 'Fireball' over a period of approximately 7.0 - 7.0 minutes.</sub><blockquote><sub>A report / video of 7 minutes of an orb spotted & recorded in Houston, Texas.Hello Peter Davenport,  I would like to report a red/orange orb that I recorded for approximately 7 minutes from around 2010.  I need a location to post these videos.  I have filled out numerous form on a plethora of sites with no response and I just heard your program on Jeff Rense from Friday November 20, 2015.I would like for the video to be available for your next program with Jeff & too see if those that have reported these orbs/fireballs are witnessing the same object if possible.The sky was pasty blue (would have been 'blue' if it were not for the chemtrail residue) with some large white clouds.  It was around 5:00 PM.  The winds were blowing from West to East and the orange red orb that I recorded was moving from East to West (so a Chinese lantern could be eliminated).  After moving to the West for about 2 (two) minutes, the object changed direction to North for about 5 (five) minutes.Once the orb stopped directly above me, it stay there for about 4 (minutes) at which time my neck became to sore to look straight up at.If you would like to view the videos please get back in touch with me.Thanks for your time.((NUFORC Note:  Witness indicates that the date of the sighting is approximate.  PD))</sub></blockquote><sub><sub><i>source: [http://www.nuforc.org/webreports/reports/124/S124295.html](http://www.nuforc.org/webreports/reports/124/S124295.html)</i></sub></sub></sub><br>
<h5><details open>
