...
<sub>last updated at 02:05:28 on 21 October 2023 (UTC) and again in an hour hence with data from the <i><a href="https://nuforc-sightings-database-api.herokuapp.com/">nuforc-sightings-database-api</a></i></sub><br>

![neural-network-icon-16](./images/hud_cursor_01.gif "feature") <sub>On this day in 2017, an anonymous witness in Sacramento (CA) reported seeing craft that fit the description of some 'Circle' over a period of approximately 5.0 - 5.0 minutes.</sub><blockquote><sub>Two very high altitude craft flying toward each other on collision course, then both stopped, hovered.I saw two very high-altitude objects moving toward each other almost on a collision course.  The two objects stopped moving when they got close to each other.  Both objects hovered for several minutes.  One would flicker its lights, then the other would flicker.</sub></blockquote><sub><sub><i>source: [http://www.nuforc.org/webreports/reports/136/S136958.html](http://www.nuforc.org/webreports/reports/136/S136958.html)</i></sub></sub></sub><br>
<h5><details open>
