...
<sub>last updated at 12:00:28 on 25 June 2023 (UTC) and again in an hour hence with data from the <i><a href="https://nuforc-sightings-database-api.herokuapp.com/">nuforc-sightings-database-api</a></i></sub><br>

![neural-network-icon-16](./images/hud_cursor_01.gif "feature") <sub>On this day in 2016, an anonymous witness in Flowood (MS) reported seeing craft that fit the description of some 'Flash' over a period of approximately 15.0 - 15.0 minutes.</sub><blockquote><sub>small yellow light, intermittent light, then dark,light,then dark, then bright flash,then dark,light, dark then light, then bright flash, dark, light, dark, light, then one more bright flash. then gone.  it was moving west to east.</sub></blockquote><sub><sub><i>source: [http://www.nuforc.org/webreports/reports/128/S128086.html](http://www.nuforc.org/webreports/reports/128/S128086.html)</i></sub></sub></sub><br>
<h5><details open>
