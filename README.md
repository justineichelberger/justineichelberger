...
<sub>last updated at 15:00:30 on 17 August 2024 (UTC) and again in an hour hence with data from the <i><a href="https://nuforc-sightings-database-api.herokuapp.com/">nuforc-sightings-database-api</a></i></sub><br>

![neural-network-icon-16](./images/hud_cursor_01.gif "feature") <sub>On this day in 1989, an anonymous witness in North Lake (Canada) (NB) reported seeing craft that fit the description of some 'Changing' over a period of approximately 10.0 - 10.0 minutes.</sub><blockquote><sub>Bright full moon, surrounded by haze but it wasn't the moon.  It began moving to our left. Changing shape as it moves. Bright full moon, surrounded by haze but it wasn't the moon. It began moving to our left. Changing shape as it moves.  Always had a "star" in front of it.  Star came shooting from other direction, then everything disappeared.((NUFORC Note:  Source of report indicates that the date of the sighting is approximate.  PD))((ADDENDUM FROM WITNESS))Hello Peter.I have no photographic evidence. The object looked like a full moon surrounded by cloud.  As soon as we noticed it, we all stopped.  The object started to move across the sky, to our left.  Still looked like a full moon surrounded by clouds and the small star was outside of the cloudy area but in front of the object.  We stood in shock. It began to move, as we did We would stop walking, it would stop. It then started changing shape, still cloudy and the star remained.  It went from a full moon to a half moon, semi-circle.  The object continued across the sky, changing...we finally stopped walking.  We never realized at the time but when we stopped walking, we were between two very large pines.  The object was now a verticle cylinder...still covered in cloud, star still leading the way.As we watched, the object stopped directly in front of us...as we looked on from between the large pines.  It was still a vertical cylinder, cloudy and the star...then, from the opposite direction, another "star" comes shooting towards the object.  It "goes into the other star" then everything disappeared.We snapped out of our stuper, jumped into the car, locked the doors (lol) then drove for 2 hours to see if we could spot it again.I have attached a crude drawing of the experience.I have looked and looked but have never found another sitting such as ours.  Even after all the years, it is still with me, like it happened last week.Thank you for taking the time to read this.Sincerely;((name deleted))((END ADDENDUM))</sub></blockquote><sub><sub><i>source: [http://www.nuforc.org/webreports/reports/144/S144331.html](http://www.nuforc.org/webreports/reports/144/S144331.html)</i></sub></sub></sub><br>
<h5><details open>
