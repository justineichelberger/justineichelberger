...
<sub>last updated at 16:00:34 on 20 June 2022 (UTC) and again in an hour hence with data from the <i><a href="https://nuforc-sightings-database-api.herokuapp.com/">nuforc-sightings-database-api</a></i></sub><br>

![neural-network-icon-16](./images/hud_cursor_01.gif "feature") <sub>On this day in 2021, an anonymous witness in none-Frenchman Coulee Gorge (WA) reported seeing craft that fit the description of some 'Triangle' over a period of approximately 10.0 - 10.0 minutes.</sub><blockquote><sub>Glowing objects in daylight sky revealed as triangular craftsSightseeing in gorge on roadside observing waterfall close to noon (approx. 11:47 am) on cloudless sunny day, with airline contrail visible in sky to our center-right position. Person in our party, with 40+ year career in military/corporate aviation, spotted 3 glowing lights in upper sky (below contrail height, but well over 2000 ft. height) coming from horizon line approaching us from the north with southward path in a horizontal formation. When the lights were closer to us, yet still north of edge of gorge and waterfalll, we saw the three glowing objects form a vertical line, then a horizontal line, then a triangular formation; objects were spaced out in position, not immediately (such as 5 object spaces) next to each other and seemed to be holding/stationary in the sky. Object on the right hand side of triangular formation shot out to the east/right, than snapped back into its position on the right of the triangle. At this point, all we saw were brilliant! ly glowing spots in sky until all 3 objects rotated in same positions in sky from left to right (west to east). At this point, only one side of the craft was revealed to be triangular, silver, and multi-dimensional shape (not a flat side) with the brilliant glowing orb/light still to the left side of the craft. The silver-colored side reflected in the sun brilliantly and clearly showing its dimensionality and seemed to hold that position for a few seconds, It rotated back, so that we could only see it as a glowing light again, which disguised its shape. After this aerial display, the craft resumed their journey to the south, flying directly over us in a triangular formation; directly overhead, looking up, they appeared to be triangular shapes. Another car with 2 passengers stopped next to us to watch the first part of the display, then left the scene. As the objects were flying overhead, another set of 3 glowing lights/orbs was spotted on the horizon, again, headed southward toward us. At this point, we decided to leave the area. We discussed attempting to take photos of the objects, but decided our phone cameras could not capture the objects very well, and we were riveted by the aerial display. There was no sound in the gorge area at the time, and no sound emitted at any time by the objects in the sky. I live approx 6.6 miles directly south of runways of one of the largest commercial airports in the country. In my opinion, from observing commercial jet airplanes constantly departing/taking off, the craft observed turning in the sun was the size of a commercial plane on its sides. I am also very familiar with the sounds of large commercial aircraft as they land or take off or cross over my residence, and these objects did not emit a sound as they passed over us. As they passed over us, they were significantly higher in the sky than a commercial airliner flying over my residence on takeoff from my local airport, but lower than airplanes seen in our area only passing over VOR points.</sub></blockquote><sub><sub><i>source: [http://www.nuforc.org/webreports/reports/164/S164090.html](http://www.nuforc.org/webreports/reports/164/S164090.html)</i></sub></sub></sub><br>
<h5><details open>
